...
class Search {
  constructor() {
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "doSearch", e => {
      if (this.searchField.value !== this.previousValue) {
        clearTimeout(this.searchTimeout);

        if (this.searchField.value) {
          !this.spinner && (this.resultsDiv.innerHTML = '<div class="spinner-loader"></div>');
          this.spinner = true;
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "getResults", () => {
      ...
      (async () => {
        ...
        <div class="row">
            ...
            ${obj.general.length ? '<ul class="link-list min-list">' : "<p>No general information found.</p>"} 
        ${obj.general.map(item => `<li><a href="${item.URL}">${item.title}</a> ${item.type === "post" ? `by ${item.authorname}` : ""}</li>`).join("")}
        ...
        ${obj.general.length ? "</ul>" : ""}
            ...
            ${obj.program.length ? '<ul class="link-list min-list">' : "<p>No programs found.<a href='/programs'> View all</a></p>"} 
        ${obj.program.map(item => `<li><a href="${item.URL}">${item.title}</a>
              </li>`).join("")}

        ${obj.program.length ? "</ul>" : ""}

            <h2 class="search-overlay__section-title"> Professors </h2>
            ${obj.professor.length ? '<ul class="professor-cards">' : "<p>No professors found.</p>"} 
        ${obj.professor.map(item => `
    <li class="professor-card__list-item">
        ...
        ${obj.professor.length ? "</ul>" : ""}
            ...
            <div class="one-third">
            <h2 class="search-overlay__section-title">Campuses</h2>    ${obj.campus.length ? '<ul class="link-list min-list">' : "<p>No campuses found.<a href='/campuses'> View all</a></p>"} 
        ${obj.campus.map(item => `<li><a href="${item.URL}">${item.title}</a> 
              </li>`).join("")}

        ${obj.campus.length ? "</ul>" : ""}
            <h2 class="search-overlay__section-title">Events</h2>${obj.event.length ? "" : "<p>No events found.<a href='/events'> View all</a></p>"} 
        ${obj.event.map(item => `
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "keyPressHandler", e => {
      document.activeElement.tagName !== "INPUT" && document.activeElement.tagName !== "TEXTAREA" && !this.isOpen && e.keyCode === 83 && this.openOverlay();
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "addHTML", () => {
      document.querySelector("body").insertAdjacentHTML("beforeend", `<div class="search-overlay">
  ...
  events() {
    this.openButton.forEach(el => el.addEventListener("click", e => {
      e.preventDefault();
      this.openOverlay();
    }));
...
class myNotes {
  constructor() {
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "createNote", e => {
      const newPost = {
        status: "publish",
      ...
      (async () => {
        try {
          ...
          document.querySelectorAll(".new-note-title, .new-note-body").forEach(e => {
            e.value = "";
          });
...
${obj.content.raw}
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "updateNote", e => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "editNote", e => {
      const thisNote = e.target.closest("li");
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "makeNoteEditable", thisNote => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "makeNoteReadOnly", thisNote => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "deleteNote", e => {
      const thisNote = e.target.closest("li");
      const opts = {
        method: "DELETE",
        headers: {
